const es = {
  ...
  manifesto_historia: "Existe un Perú profundo que late con fuerza en el silencio de sus montañas. Allí, en los valles del Cusco, agricultores que el sistema olvidó cuidan con devoción el cacao Chuncho Orgánico, sanando una tierra golpeada por el abandono y los precios injustos. Estos productores son el alma de la resistencia; hombres y familias campesinas que se levantaron con puro coraje frente a promesas vacías e intermediarios que los explotaron. Con el viento en contra y sin un Estado que los respalde, decidieron no rendirse, transformando el dolor en orgullo y eligiendo la dignidad como el único camino para proteger sus raíces. COMPARTO_TU_ESPERANZA es el abrazo que une esa valentía incansable contigo. Creamos este puente para que, al otro lado del océano, cada onza de chocolate que pruebes deje de ser un simple placer y se convierta en un abrazo de vuelta, en una inversión real en la vida de quienes lo dan todo por su tierra. Elegir este Cacao Chuncho Orgánico no es solo un asunto de buen gusto; es mirarlos a los ojos, reconocer su valor y comprometerse con la reconstrucción de un legado sagrado que ellos, contra todo pronóstico, decidieron salvar.",
  ...
  // Footer
  footer_tagline: "Cacao Chuncho Orgánico del Cusco,\nPerú.",
  ...
  vision_card3_title: "Nuestra Alianza en República Checa",
  vision_card3_body: "Nuestra filial en {{CZECH}} es el puente que conecta a Salkantay Andino con Europa: gestiona alianzas, abre mercados y respalda cada exportación bajo los más altos estándares. Gracias a nuestra presencia en {{CZECH}}, el Cacao Chuncho Orgánico de Cusco llega más lejos, con mayor respaldo y visibilidad internacional.",
  process_step1_title: "Cultivo",
  process_step1_subtitle: "Cacao Chuncho Orgánico nativo de altura",
  process_step1_desc: "Cacao Chuncho Orgánico nativo cultivado en altitudes de 800-1200m en los valles del Cusco.",
  ...
  unidos_frase: "El mejor cacao nace cuando la tierra, el corazón y la esperanza trabajan juntos y se vuelven una familia.",
};
