const es = {
  ...
  // Footer
  footer_tagline: "Cacao Chuncho Orgánico de Cusco,\nPerú.",
  ...
  mision_paragraph_1: "Construir una gran familia basada en la lealtad, la honestidad y la confianza mutua, uniendo fuerzas con los productores más comprometidos de Cusco para transformar sus vidas y hacer realidad sus sueños.",
