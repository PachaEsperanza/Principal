const cs = {
  ...
  hero_desc: "Kakao Chuncho z Echarati, La Convención, Cusco. Sklízeno rodinami, které znovu uvěřily, fermentováno s trpělivostí a předáno světu s neporušenými příběhy.",
  ...
  vision_card1_body: "Učinit z kakaa z Echarati mezinárodně nejuznávanější referenci kvality a sociálního dopadu, aby se každý producent stal hlavním hrdinou svého úspěchu a vyvážel svůj příběh do světa.",
